...
{	
	...
	{		
		...
		try 
		{
			...
			int i=cellType.pos_i,j=cellType.pos_j;
			...
			UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i+sqrt)%sqrt)+"-"+((j+1+sqrt)%sqrt)+"L",updates,listeners);
			u.start();
			//listeners.add(u.getListener());
			
			UpdaterThreadForListener u2 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i+sqrt)%sqrt)+"-"+((j-1+sqrt)%sqrt)+"R",updates,listeners);
			u2.start();
			//listeners.add(u2.getListener());
			
			UpdaterThreadForListener u3 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i+1+sqrt)%sqrt)+"-"+((j+sqrt)%sqrt)+"U",updates,listeners);
			u3.start();
			//listeners.add(u3.getListener());
			
			UpdaterThreadForListener u4 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i-1+sqrt)%sqrt)+"-"+((j+sqrt)%sqrt)+"D",updates,listeners);
			u4.start();
			//listeners.add(u4.getListener());
			
			UpdaterThreadForListener u5 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i-1+sqrt)%sqrt)+"-"+((j-1+sqrt)%sqrt)+"CDDR",updates,listeners);
			u5.start();
			//listeners.add(u5.getListener());
			
			UpdaterThreadForListener u6 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i-1+sqrt)%sqrt)+"-"+((j+1+sqrt)%sqrt)+"CDDL",updates,listeners);
			u6.start();
			//listeners.add(u6.getListener());
			
			
			UpdaterThreadForListener u7 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i+1+sqrt)%sqrt)+"-"+((j-1+sqrt)%sqrt)+"CUDR",updates,listeners);
			u7.start();
			//listeners.add(u7.getListener());
			
			
			UpdaterThreadForListener u8 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,((i+1+sqrt)%sqrt)+"-"+((j+1+sqrt)%sqrt)+"CUDL",updates,listeners);
			u8.start();
			//listeners.add(u8.getListener());
