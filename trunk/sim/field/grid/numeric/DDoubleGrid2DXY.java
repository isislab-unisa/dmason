...
import dmason.sim.field.UpdaterNumericThreadForListener;
 ...
 * </PRE>
 */
public class DDoubleGrid2DXY extends DDoubleGrid2D {
	/**
	...
	public DDoubleGrid2DXY(int width, int height,SimState sm,int max_distance,int i,int j,int num_peers,
			String name, double initialGridValue, boolean fixed) 
	{	
	...
	private boolean createRegion() {
		...
		if(rmap.left_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType.toString()+"L"+NAME);
				connection.subscribeToTopic(cellType.getNeighbourLeft()+"R"+NAME);

				(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourLeft()+"R"+NAME,updates)).start();
			} catch (Exception e) { e.printStackTrace(); }
		}
		...
		if(rmap.right_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType+"R"+NAME);
				connection.subscribeToTopic(cellType.getNeighbourRight()+"L"+NAME);
				(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourRight()+"L"+NAME,updates)).start();
			} catch (Exception e) { e.printStackTrace(); }
		}
		...
		if(rmap.up_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType+"U"+NAME);
				connection.subscribeToTopic((cellType.getNeighbourUp()+"D"+NAME));
				(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourUp()+"D"+NAME,updates)).start();
			}catch (Exception e) { e.printStackTrace(); }
		}
		...
		if(rmap.down_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType+"D"+NAME);
				connection.subscribeToTopic(cellType.getNeighbourDown()+"U"+NAME);
				(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDown()+"U"+NAME,updates)).start();
			} catch (Exception e) { e.printStackTrace(); }
		}
		if(rmap.left_out == null)
		{
			if(rmap.up_out == null)
			{
				...
				try 
				{
					connection.createTopic(cellType+"CDDR"+NAME);
					connection.subscribeToTopic(cellType.getNeighbourDiagRightDown()+"CUDL"+NAME);
					(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightDown()+"CUDL"+NAME,updates)).start();
				} catch (Exception e) { e.printStackTrace(); }
			}
			else
				if(rmap.down_out==null)
				{
					...
					try 
					{
						connection.createTopic(cellType+"CUDR"+NAME);
						connection.subscribeToTopic(cellType.getNeighbourDiagRightUp()+"CDDL"+NAME);
						(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightUp()+"CDDL"+NAME,updates)).start();
					} catch (Exception e) { e.printStackTrace(); }
				}
				else
				{
			...
			if(rmap.right_out==null)
			{
				if(rmap.up_out==null)
				{
					...
					try 
					{
						connection.createTopic(cellType+"CDDL"+NAME);
						connection.subscribeToTopic(cellType.getNeighbourDiagLeftDown()+"CUDR"+NAME);						
						(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagLeftDown()+"CUDR"+NAME,updates)).start();
					} catch (Exception e) { e.printStackTrace(); }
				}
				else
					if(rmap.down_out==null)
					{
						...
						try 
						{
							connection.createTopic(cellType+"CUDL"+NAME);
							connection.subscribeToTopic((cellType.getNeighbourDiagLeftUp()+"CDDR"+NAME));
							(new UpdaterNumericThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagLeftUp()+"CDDR"+NAME,updates)).start();
						} catch (Exception e) { e.printStackTrace(); }
	...
	public boolean synchro() {
		...
		if(!FIXED){
			...
			{			
				Int2D loc=e.l;
				//System.out.println("int2d = x=" + e.l.x + " y=" + e.l.y);
				double d = e.r;
			...
			if(rmap.left_out!=null)
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.left_mine,rmap.left_out,
						(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.LEFT);
			...
			if(rmap.right_out!=null)
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.right_mine,rmap.right_out,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.RIGHT);				
			...
			if(rmap.up_out!=null )
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new  DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.up_mine,rmap.up_out,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.UP);
			...
			if(rmap.down_out!=null )
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.down_mine,rmap.down_out,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.DOWN);
				connection.publishToTopic(dr,cellType.toString()+"D"+NAME);
			 } catch (Exception e1) { e1.printStackTrace(); }
			}
			if(rmap.corner_out_up_left_diag!=null)
			{
				DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.corner_mine_up_left,rmap.corner_out_up_left_diag,
			...
			{
				DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.corner_mine_up_right,rmap.corner_out_up_right_diag,
			...
			{
				DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.corner_mine_down_left,
						rmap.corner_out_down_left_diag,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.CORNER_DIAG_DOWN_LEFT);
				try 
				{
			...
			{
				DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>(rmap.corner_mine_down_right,
						rmap.corner_out_down_right_diag,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.CORNER_DIAG_DOWN_RIGHT);
			...
			PriorityQueue<DistributedRegionNumeric<Integer,EntryNum<Double,Int2D>>> q;
			try 
			{
				q = updates.getUpdates(sm.schedule.getSteps()-1, neighborhood.size());
				while(!q.isEmpty())
				{
					DistributedRegionNumeric<Integer, EntryNum<Double,Int2D>> region=q.poll();
