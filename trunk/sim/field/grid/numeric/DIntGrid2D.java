...
import dmason.sim.field.UpdateMapNumeric;
...
public abstract class DIntGrid2D extends IntGrid2D implements DistributedField<Int2D>{
	 ...
	 */
	public UpdateMapNumeric<Integer,EntryNum<Integer,Int2D>> updates=new UpdateMapNumeric<Integer,EntryNum<Integer,Int2D>>();
    public SimState sm ;
