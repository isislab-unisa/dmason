...
public class DIntGrid2DXY extends DIntGrid2D {
	...
	public DIntGrid2DXY(int width, int height,SimState sm,int max_distance,int i,int j,int num_peers, 
			String name, Integer initialGridValue, boolean fixed) 
	{		
	...
	public boolean synchro() {
		...
		if(!FIXED){
			...
			if(rmap.left_out!=null)
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.left_mine,rmap.left_out,
			...
			if(rmap.right_out!=null)
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.right_mine,rmap.right_out,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.RIGHT);				
			...
			if(rmap.up_out!=null )
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new  DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.up_mine,rmap.up_out,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.UP);
			...
			if(rmap.down_out!=null )
			{
			 try 
			 {
				 DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.down_mine,rmap.down_out,(sm.schedule.getSteps()-1),cellType,DistributedRegionNumeric.DOWN);
				connection.publishToTopic(dr,cellType.toString()+"D"+NAME);
			 } catch (Exception e1) { e1.printStackTrace(); }
			}
			if(rmap.corner_out_up_left_diag!=null)
			{
				DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.corner_mine_up_left,rmap.corner_out_up_left_diag,
			...
			{
				DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.corner_mine_up_right,rmap.corner_out_up_right_diag,
			...
			{
				DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.corner_mine_down_left,
			...
			{
				DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>> dr=new DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>(rmap.corner_mine_down_right,
			...
			PriorityQueue<DistributedRegionNumeric<Integer,EntryNum<Integer,Int2D>>> q;
			try 
			{
				q = updates.getUpdates(sm.schedule.getSteps()-1, neighborhood.size());
				while(!q.isEmpty())
				{
					DistributedRegionNumeric<Integer, EntryNum<Integer,Int2D>> region=q.poll();
