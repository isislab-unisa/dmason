...
{	
	...
	private ConnectionWithJMS con = new ConnectionWithActiveMQAPI();
	
	public DSparseGrid2DXY(int width, int height,SimState sm,int max_distance,int i,int j,int num_peers) 
	{		
		super(width, height);
	...
	private boolean createRegion()
	{
		...
		if(rmap.left_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType.toString()+"L");
				connection.subscribeToTopic(cellType.getNeighbourLeft()+"R");
				
				UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourLeft()+"R",updates,listeners);
				u.start();
		...
		if(rmap.right_out!=null)
		{
			...
			try 
			{
				...
				UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourRight()+"L",updates,listeners);
				u.start();
			//	listeners.add(u.getListener());
		...
		if(rmap.up_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType+"U");
				connection.subscribeToTopic((cellType.getNeighbourUp()+"D"));
				

				UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourUp()+"D",updates,listeners);
				u.start();
				//listeners.add(u.getListener());
		...
		if(rmap.down_out!=null)
		{
			...
			try 
			{
				connection.createTopic(cellType+"D");
				connection.subscribeToTopic(cellType.getNeighbourDown()+"U");
				
				UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDown()+"U",updates,listeners);
				u.start();
				//listeners.add(u.getListener());
		...
		if(rmap.left_out == null)
		{
			if(rmap.up_out == null)
			{
				...
				try 
				{
					connection.createTopic(cellType+"CDDR");
					connection.subscribeToTopic(cellType.getNeighbourDiagRightDown()+"CUDL");
					
					UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightDown()+"CUDL",updates,listeners);
					u.start();
					//listeners.add(u.getListener());
				} catch (Exception e) { e.printStackTrace(); }
			}
			...
			if(rmap.down_out==null)
			{
				...
				try 
				{
					connection.createTopic(cellType+"CUDR");
					connection.subscribeToTopic(cellType.getNeighbourDiagRightUp()+"CDDL");
					
					UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightUp()+"CDDL",updates,listeners);
					u.start();
					//listeners.add(u.getListener());
			...
			else
			{
				...
				try 
				{
					...
					UpdaterThreadForListener u1 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightDown()+"CUDL",updates,listeners);
					u1.start();
					//listeners.add(u1.getListener());
		...
		if(rmap.right_out==null)
		{
			if(rmap.up_out==null)
			{
				...
				try 
				{
					connection.createTopic(cellType+"CDDL");
					connection.subscribeToTopic(cellType.getNeighbourDiagLeftDown()+"CUDR");	
					
					UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagLeftDown()+"CUDR",updates,listeners);
					u.start();
					//listeners.add(u.getListener());
				} catch (Exception e) { e.printStackTrace(); }
			}
			...
			if(rmap.down_out==null)
			{
				...
				try 
				{
					connection.createTopic(cellType+"CUDL");
					connection.subscribeToTopic((cellType.getNeighbourDiagLeftUp()+"CDDR"));
					
					UpdaterThreadForListener u = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagLeftUp()+"CDDR",updates,listeners);
					u.start();
					//listeners.add(u.getListener());
			...
			{	
				...
				try 
				{
					...
					UpdaterThreadForListener u1 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagLeftDown()+"CUDR",updates,listeners);
					u1.start();	
					//listeners.add(u1.getListener());
		...
		if(rmap.down_out==null)
		{
			...
			try 
			{
				...
				UpdaterThreadForListener u1 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightUp()+"CDDL",updates,listeners);
				u1.start();
				//listeners.add(u1.getListener());
		...
		else
		{
			...
			try 
			{
				...
				UpdaterThreadForListener u2 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightUp()+"CDDL",updates,listeners);
				u2.start();
				//listeners.add(u2.getListener());
				
				UpdaterThreadForListener u3 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagLeftDown()+"CUDR",updates,listeners);
				u3.start();
				//listeners.add(u3.getListener());
				
				UpdaterThreadForListener u4 = new UpdaterThreadForListener(connection, this.cellType,this.NUMPEERS,this,neighborhood,cellType.getNeighbourDiagRightDown()+"CUDL",updates,listeners);
				u4.start();
				//slisteners.add(u4.getListener());
	...
	{		
		...
		if(rmap.left_out!=null)
		{
		 try 
		 {
			...
			connection.publishToTopic(dr,cellType+"L");
		...
		if(rmap.right_out!=null)
		{
		 try 
		 {
			...
			connection.publishToTopic(dr,cellType.toString()+"R");
		 } catch (Exception e1) {e1.printStackTrace(); }
		}
		if(rmap.up_out!=null )
		{
		 try 
		 {
			...
			connection.publishToTopic(dr,cellType.toString()+"U");
		 } catch (Exception e1) {e1.printStackTrace();}
		}
		...
		if(rmap.down_out!=null )
		{
		 try 
		 {
			...
			connection.publishToTopic(dr,cellType.toString()+"D");
		 } catch (Exception e1) { e1.printStackTrace(); }
		}
		...
		if(rmap.corner_out_up_left_diag!=null)
		{
			...
			try 
			{
				connection.publishToTopic(dr,cellType.toString()+"CUDL");
			} catch (Exception e1) { e1.printStackTrace();}
		}
		if(rmap.corner_out_up_right_diag!=null)
		{
			...
			try 
			{
				connection.publishToTopic(dr,cellType.toString()+"CUDR");
			} catch (Exception e1) {e1.printStackTrace();}
		}
		if( rmap.corner_out_down_left_diag!=null)
		{
			...
			try 
			{
				connection.publishToTopic(dr,cellType.toString()+"CDDL");
			} catch (Exception e1) {e1.printStackTrace();}
		}
		if(rmap.corner_out_down_right_diag!=null)
		{
			...
			try 
			{
				connection.publishToTopic(dr,cellType.toString()+"CDDR");
			} catch (Exception e1) { e1.printStackTrace(); }
		}//<--
		...
		PriorityQueue<DistributedRegion<Integer,Int2D>> q;
		try 
		{
			q = updates.getUpdates(sm.schedule.getSteps()-1, neighborhood.size());
			while(!q.isEmpty())
			{
				DistributedRegion<Integer, Int2D> region=q.poll();
