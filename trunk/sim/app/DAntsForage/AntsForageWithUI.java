...
public class AntsForageWithUI extends GUIState
    ...
    public AntsForageWithUI(Object[] args) { 
    	super(new AntsForage(args)); 
    ...
    public void setupPortrayals()
        ...
        homePheromonePortrayal.setMap(new sim.util.gui.SimpleColorMap(0, AntsForage.LIKELY_MAX_PHEROMONE,
