...
For restart simulation there is reset button, highlighted by the red circle, see \ref{fig:mastersr}. When the button is clicked the current simulation stops and the parameters can be edit again and the simulation can be changed or not.
