...
public class Tutorial4 extends SimState
    ...
    public void start()
        ...
        Steppable decreaser = new Steppable()
            ...
            // anonymous class -- here's the serialVersionUID (see sim.app.tutorial3_1)
            // by the way, notice it's DIFFERENT from sim.app.tutorial3_1's due to new names of stuff.
    ...
    // contains an anonymous class -- here's the serialVersionUI (see sim.app.tutorial3_1)
    // by the way, notice it's DIFFERENT from sim.app.tutorial3_1's due to new names of stuff.
    // No biggie -- as long as you have <i>some</i> serialVersionUID...
