...
import dmason.launcher.Launcher;
...
public class Wizard extends JFrame
{
	...
	public Wizard(Launcher launcher)
	{
		...
		icoStatusNo = new ImageIcon(ClassLoader.getSystemClassLoader().getResource("dmason/resource/image/status-unknow.png"));
		icoStatusOk = new ImageIcon(ClassLoader.getSystemClassLoader().getResource("dmason/resource/image/status-up.png"));
		...
		/* Window left column */
		lblStatusWrapper = new JLabel("ActiveMQ Server", icoStatusNo, JLabel.LEADING);
		lblStatusWorkers = new JLabel("Workers", icoStatusNo, JLabel.LEADING);
		lblStatusMaster = new JLabel("Master", icoStatusNo, JLabel.LEADING);
		lblStatusInspector = new JLabel("Inspector", icoStatusNo, JLabel.LEADING);
