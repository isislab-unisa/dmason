...
public abstract class RemoteVertex15<Double2D> extends SimplePortrayal2D implements Serializable, RemoteUnpositionedAgent<Double2D> {
	...
	public String id;
	public RemoteVertex15() {}

	/**
     * Constructor of Remote Agent
	 * @param state the Distributed State of simulation
	 */
    public RemoteVertex15(DistributedState<Double2D> state,String label){
			int i=state.nextId();
