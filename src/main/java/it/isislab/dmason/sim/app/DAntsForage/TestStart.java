...
public class TestStart {
	...
	//don't modify this...
	private static int MODE = (rows==1 || columns==1)? DDoubleGrid2DFactory.HORIZONTAL_BALANCED_DISTRIBUTION_MODE : DDoubleGrid2DFactory.SQUARE_BALANCED_DISTRIBUTION_MODE; 
