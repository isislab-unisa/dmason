...
{
	public VertexesWithUI()
	{
		super(new Vertexes(System.currentTimeMillis(), "resources/app/DNetworkTest/Examples-graph/karate.gexf"));
	}

	public VertexesWithUI(SimState state) {
		super(state);
	...
	{
		new VertexesWithUI().createController();
	} 
