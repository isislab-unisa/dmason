...
//			try {
//				FileWriter writer = new FileWriter("/home/matdar/Scrivania/test/steptime"+state.TYPE+".txt", true);
...
//		}
    ...
    public ArrayList<DistributedField3D> get3DFields(){return fields3D; }
    public void setFields(ArrayList<DistributedField2D> fields) { this.fields2D = fields; }
    public void set3DFields(ArrayList<DistributedField3D> fields) {this.fields3D=fields; }
    public void add3DField(DistributedField3D<E> f){fields3D.add(f);}
