...
public class SandBoxCordascoOpt {
	static int corfactor=4;
	static int K=2;
	public static void main(String[] args) {
		


		GraphWDispersion g= GraphWDispersion.generateGraphSubOptimal(corfactor);
		if(g==null){
...
//		}
        ...
        frame.setTitle("JGraph ISISLab - Cordasco Network ^"+corfactor+" Dispersion and Community for K="+K);
