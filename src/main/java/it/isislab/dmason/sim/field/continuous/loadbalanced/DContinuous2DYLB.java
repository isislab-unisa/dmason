...
public class DContinuous2DYLB extends DContinuous2D implements TraceableField
{	
	private static final long serialVersionUID = 1L;

	private static Logger logger = Logger.getLogger(DContinuous2DYLB.class.getCanonicalName());
