...
public class KaffpaProcessBinding implements PartitioningAlgorithm {
	 ...
	 */
	public KaffpaProcessBinding(String bin_path, String graph_path, int K) {
	...
	public String partitioning() throws IOException, InterruptedException {
		...
		Process part = Runtime.getRuntime().exec(
				bin_path + " " + graph_path + " --k=" + nPart
						+ " --output_filename=" + output_file);
		int status = part.waitFor();

		if (status != 0) {
			System.err.println("Error in calling kaffpa!");
			System.exit(0);
		}
