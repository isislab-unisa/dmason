...
public class DDoubleGrid2DYLB extends DDoubleGrid2D implements DistributedField2DLB {
	...
	public synchronized boolean  synchro() {
		...
		if( rmap.left_out!=null )
		{
			...
			DistributedRegionNumericLB<Integer,EntryNum<Double,Int2D>> dr1=new DistributedRegionNumericLB<Integer,EntryNum<Double,Int2D>>(rmap.left_mine.clone(),rmap.left_out.clone(),(sm.schedule.getSteps()-1),cellType,DistributedRegionNumericLB.LEFT,((DistributedField2DLB)((DistributedState)sm).getField()).getNumAgents(), getLeftMineSize(),my_width/*,cellsLeft*/);
			try 
			{	
