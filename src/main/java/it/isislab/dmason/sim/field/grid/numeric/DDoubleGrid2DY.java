...
public class DDoubleGrid2DY extends DDoubleGrid2D {
	 ...
	 */
	public DDoubleGrid2DY(int width, int height,SimState sm,int max_distance,int i,int j,int rows, int columns, double initialGridValue, String name, String prefix) {
