 ...
 * @param <F> the specific type of location of a value
 * 
...
public abstract class RegionNumeric<E, F> extends HashMap<String,F> implements Serializable, Cloneable{
	 ...
	 */
	public RegionNumeric(E upl_xx,E upl_yy, E down_xx, E down_yy) 
	{
		super();
		this.upl_xx = upl_xx;
		this.upl_yy = upl_yy;
	...
	@Override
	public abstract RegionNumeric<E,F> clone();
	 ...
	 * @return true o false
	 */
	public abstract boolean addEntryNum(F e);
