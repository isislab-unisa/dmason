...
public class DParticlesWithUI extends GUIState
{
    ...
    FastObjectGridPortrayal2D trailsPortrayal = new FastObjectGridPortrayal2D();
...
*/
    ...
    public void setupPortrayals()
    {
        ...
        trailsPortrayal.setField(((DParticles)state).trails);
        trailsPortrayal.setMap( new sim.util.gui.SimpleColorMap( 0.0,1.0,Color.black,Color.white));
