...
public abstract class DDoubleGrid2DThin extends DDoubleGrid2D{
	 ...
	 */
	public DDoubleGrid2DThin(int localWidth, int localHeight, int width, int height, double initialValue) {
    ...
    public abstract void setThin(final int x, final int y, final double val);
    
    /** Returns the element at location (x,y) */
    public abstract double getThin(final int x, final int y);
    
    /** Sets all the locations in the grid the provided element */
    public final DoubleGrid2D setToThin(final double thisMuch)
        {
        double[] fieldx = null;
    ...
    public DoubleGrid2D setToThin(double[][] field)
        {
        // check info
    ...
    /** Flattens the grid to a one-dimensional array, storing the elements in row-major order,including duplicates and null values. 
        Returns the grid. */
    public final double[] toArrayThin()
        {
    ...
    */
    public final DoubleGrid2D upperBoundThin(final double toNoMoreThanThisMuch)
        {
        double[] fieldx = null;
        final int width = this.localWidth;
        final int height = this.localHeight;
    ...
    /** Thresholds the grid so that values smaller than <i>toNoLowerThanThisMuch</i> are changed to <i>toNoLowerThanThisMuch</i>
        Returns the modified grid. 
    */
    public final DoubleGrid2D lowerBoundThin(final double toNoLowerThanThisMuch)
        {
        double[] fieldx = null;
        final int width = this.localWidth;
        final int height = this.localHeight;
    ...
    /** Sets each value in the grid to that value added to <i>withThisMuch</i>
        Returns the modified grid. 
    */
    public final DoubleGrid2D addThin(final double withThisMuch)
        {
    	 final int width = this.localWidth;
         final int height = this.localHeight;
    ...
    /** Sets the value at each location in the grid to that value added to the value at the equivalent location in the provided grid.
        Returns the modified grid. 
    */
    public final DoubleGrid2D addThin(final IntGrid2D withThis)
        {
    ...
    /** Sets the value at each location in the grid to that value added to the value at the equivalent location in the provided grid.
        Returns the modified grid. 
    */
    public final DoubleGrid2D addThin(final DoubleGrid2D withThis)
        {
    ...
    /** Sets each value in the grid to that value multiplied <i>byThisMuch</i>
        Returns the modified grid. 
    */
    public final DoubleGrid2D multiplyThin(final double byThisMuch)
        {
    ...
    /** Sets the value at each location in the grid to that value multiplied by to the value at the equivalent location in the provided grid.
        Returns the modified grid. 
    */
    public final DoubleGrid2D multiplyThin(final IntGrid2D withThis)
        {
        final int[][] otherField = withThis.field;
        double[] fieldx = null;
        int[] ofieldx = null;
    ...
    /** Sets the value at each location in the grid to that value multiplied by to the value at the equivalent location in the provided grid.
        Returns the modified grid. 
    */
    public final DoubleGrid2D multiplyThin(final DoubleGrid2D withThis)
        {
        final double[][] otherField = withThis.field;
        double[] fieldx = null;
        double[] ofieldx = null;
    ...
    */
    ...
    public final DoubleGrid2D floorThin()
        {
        double[] fieldx = null;
        final int width = this.localWidth;
        final int height = this.localHeight;
    ...
    /** Sets each value in the grid to ceil(value).
        Returns the modified grid. 
    */
    public final DoubleGrid2D ceilingThin()
        {
        double[] fieldx = null;
        final int width = this.localWidth;
        final int height = this.localHeight;
    ...
    /** Eliminates the decimal portion of each value in the grid (rounds towards zero).
        Returns the modified grid. 
    */
    public final DoubleGrid2D truncateThin()
        {
        double[] fieldx = null;
        final int width = this.localWidth;
        final int height = this.localHeight;
    ...
    /** Sets each value in the grid to rint(value).  That is, each value
        ...
        Returns the modified grid. 
    */
    public final DoubleGrid2D  rintThin()
        {
        double[] fieldx = null;
        final int width = this.localWidth;
        final int height = this.localHeight;
     ...
     * each one.
     */
    public final DoubleBag getNeighborsMaxDistanceThin( final int x, final int y, final int dist, final boolean toroidal, DoubleBag result, IntBag xPos, IntBag yPos )
        {
        if( xPos == null )
            xPos = new IntBag();
        if( yPos == null )
     ...
     * each one.
     */
    public final DoubleBag getNeighborsHamiltonianDistanceThin( final int x, final int y, final int dist, final boolean toroidal, DoubleBag result, IntBag xPos, IntBag yPos )
        {
        if( xPos == null )
            xPos = new IntBag();
        if( yPos == null )
     ...
     * each one.
     */
    public final DoubleBag getNeighborsHexagonalDistanceThin( final int x, final int y, final int dist, final boolean toroidal, DoubleBag result, IntBag xPos, IntBag yPos )
        {
        if( xPos == null )
            xPos = new IntBag();
        if( yPos == null )
