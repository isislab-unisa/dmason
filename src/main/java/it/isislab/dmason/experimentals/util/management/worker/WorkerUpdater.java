...
public class WorkerUpdater extends javax.swing.JFrame 
{
	...
	public WorkerUpdater(Address fptAddress, String ftpHome, String sEPARATOR2,
			MasterDaemonStarter master2, int size, String updateDir, DMasonMaster masterUI) {
		super();
		...
		try {
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				}
				{
					...
					jButtonChoseUpJar.setIcon(new ImageIcon(getClass().getClassLoader().getResource("it.isislab.dmason/resource/image/openFolder.png")));
	...
	*/
	...
	public void setProgress()
	{
		...
		jProgressBarUpdate.setValue((workerUpdated *100)/total);
		jLabelUpdatedWorker.setText(""+workerUpdated);
