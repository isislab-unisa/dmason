...
package it.isislab.dmason.experimentals.util.management.wrapper.activemq.launcher;
...
import it.isislab.dmason.experimentals.util.management.wrapper.data.BroadcastTask;
...
public class ActiveMQWrapper implements Command
{
	...
	private final static String WRAPPER_CONF = "it.isislab.dmason.configuration";
