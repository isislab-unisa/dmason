...
public class MasterServerMain {
	...
	public static void main(String[] args){
		...
		//master.getConnection().publishToTopic(new Address("127.0.0.1", "1414"), "MASTER","jar");
		//master.invokeCopyServer(master.getCopyServerPort(), "/home/miccar/Scrivania/flockers.jar");		
