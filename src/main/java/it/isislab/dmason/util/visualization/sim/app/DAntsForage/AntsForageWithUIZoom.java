 ...
 */
public class AntsForageWithUIZoom extends GUIState
    {
    ...
    public AntsForageWithUIZoom(Object[] args) { 
    	
    	super(new AntsForageZoom(args)); 
    	 con=(ConnectionNFieldsWithActiveMQAPI)args[0];
		 id_Cell=(String)args[1];
    	
    }
    
    public AntsForageWithUIZoom(SimState state) { super(state); }
    ...
    public void setupPortrayals()
        {
        AntsForageZoom af = (AntsForageZoom)state;

        // tell the portrayals what to portray and how to portray them
        homePheromonePortrayal.setField(af.toHomeGrid);
        homePheromonePortrayal.setMap(new sim.util.gui.SimpleColorMap(0, AntsForageZoom.LIKELY_MAX_PHEROMONE,
        ...
        foodPheromonePortrayal.setMap(new sim.util.gui.SimpleColorMap(
                0,
                AntsForageZoom.LIKELY_MAX_PHEROMONE,
                new Color(0,0,255,0),
