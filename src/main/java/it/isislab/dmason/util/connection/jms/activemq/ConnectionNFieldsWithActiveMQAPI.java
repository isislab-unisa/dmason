 ...
 *
 */
public class ConnectionNFieldsWithActiveMQAPI extends Observable implements ConnectionJMS, Serializable, TransportListener 
{
	...
	// metodo che dovrebbe cancellare la sottoscrizone al topic ma in realt� non si capisce come fare per farlo????
		@Override
