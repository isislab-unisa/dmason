 ...
 *
 */
public class DParticlesNonUniformPartitioningWithUI extends GUIState
{
    ...
    public DParticlesNonUniformPartitioningWithUI(GeneralParam args,List<EntryParam<String, Object>>list,String prefix) 
    { 
    	super(new DParticlesNonUniformPartitioning(args,list,prefix));
...
*/
    ...
    public void setupPortrayals()
    {
    	...
    	trailsPortrayal.setField(
            ((DParticlesNonUniformPartitioning)state).trails);
        trailsPortrayal.setMap(
            new sim.util.gui.SimpleColorMap(
               0.0,1.0,Color.black,Color.white));
        particlesPortrayal.setField(((DParticlesNonUniformPartitioning)state).particles);
        particlesPortrayal.setPortrayalForAll( new sim.portrayal.simple.OvalPortrayal2D(Color.red) );
        


        ((DParticlesNonUniformPartitioning)state).p=particlesPortrayal;
