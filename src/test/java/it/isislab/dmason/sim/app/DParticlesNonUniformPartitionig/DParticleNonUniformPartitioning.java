 ...
 *
 */
public class DParticleNonUniformPartitioning extends RemoteParticleNonUniformPartitioning<Int2D>
{
	//public boolean randomize = false;
	public int xdir;  // -1, 0, or 1
    public int ydir;  // -1, 0, or 1
    
	public DParticleNonUniformPartitioning(){ }
    public DParticleNonUniformPartitioning(DistributedState state, Int2D loc)
    {
    	super(state);
    	this.pos = loc;
    }
	...
	{
		DParticlesNonUniformPartitioning tut = (DParticlesNonUniformPartitioning)state;
