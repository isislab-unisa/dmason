 ...
 * 
 */
public class DAntsForageNonUniformPartitioningWithUI extends GUIState
    {
    ...
    public DAntsForageNonUniformPartitioningWithUI(GeneralParam args,List<EntryParam<String, Object>>list,String prefix) { 
    	super(new DAntsForageNonUniformPartitioning(args,list,prefix)); 
   ...
   // public DAntsForageWithUI(SimState state) { super(state); }
    ...
    public void setupPortrayals()
        {
        DAntsForageNonUniformPartitioning af = (DAntsForageNonUniformPartitioning)state;

        // tell the portrayals what to portray and how to portray them
        homePheromonePortrayal.setField(af.toHomeGrid);
        homePheromonePortrayal.setMap(new sim.util.gui.SimpleColorMap(0, DAntsForageNonUniformPartitioning.LIKELY_MAX_PHEROMONE,
        ...
        foodPheromonePortrayal.setMap(new sim.util.gui.SimpleColorMap(
                0,
                DAntsForageNonUniformPartitioning.LIKELY_MAX_PHEROMONE,
                new Color(0,0,255,0),
