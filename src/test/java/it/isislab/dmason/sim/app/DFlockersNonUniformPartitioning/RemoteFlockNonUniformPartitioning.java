 ...
 *
 */
public abstract class RemoteFlockNonUniformPartitioning<E> implements Serializable, RemotePositionedAgent<E> {
	...
	public RemoteFlockNonUniformPartitioning() {}

	/**
     * Constructor of Remote Agent
	 * @param state the Distributed State of simulation
	 */
    public RemoteFlockNonUniformPartitioning(DistributedState<E> state){
			int i=state.nextId();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RemoteFlockNonUniformPartitioning other = (RemoteFlockNonUniformPartitioning) obj;
		if (id == null) {
			if (other.id != null)
				return false;
