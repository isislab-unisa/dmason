 ...
 *
 */
public abstract class RemoteParticleNonUniformPartitioning<E> implements Serializable,RemotePositionedAgent<E> {
	...
	public RemoteParticleNonUniformPartitioning() {
	 ...
	 */
	public RemoteParticleNonUniformPartitioning(DistributedState<E> state){
		int i=state.nextId();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RemoteParticleNonUniformPartitioning other = (RemoteParticleNonUniformPartitioning) obj;
		if (id == null) {
			if (other.id != null)
				return false;
