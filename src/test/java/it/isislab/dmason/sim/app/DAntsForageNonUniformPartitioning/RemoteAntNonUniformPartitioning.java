 ...
 *
 */
public abstract class RemoteAntNonUniformPartitioning<E> extends OvalPortrayal2D implements Serializable,RemotePositionedAgent<E>{
	...
	public RemoteAntNonUniformPartitioning() {}
	
	  /**
     * Constructor of Remote Agent
	 * @param state the Distributed State of simulation
	 */
    public RemoteAntNonUniformPartitioning(DistributedState<E> state){
			int i=state.nextId();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RemoteAntNonUniformPartitioning other = (RemoteAntNonUniformPartitioning) obj;
		if (id == null) {
			if (other.id != null)
				return false;
