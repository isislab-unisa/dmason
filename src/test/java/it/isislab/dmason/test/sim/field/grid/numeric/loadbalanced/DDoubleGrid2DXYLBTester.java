...
/**
 * The Class DDoubleGrid2DXYLBTester. Tests the DDoubleGrid2DXYLB for a toroidal
 * distribution.
 * 
 ...
 */
public class DDoubleGrid2DXYLBTester {
	/** The to test. */
	DDoubleGrid2DXYLB toTest;

	/** The distributed state. */
	StubDistributedState ss;

	/** The remote agent. */
	//StubRemotePositionedAgent sa; no agenti valori double sa;
	...
	/**
	 * The Class StubRemotePositionedAgent. ERRORE values e not agents
	 */
...
//	}
	...
	public void setUp() throws Exception {
		...
		toTest = (DDoubleGrid2DXYLB) DDoubleGrid2DFactory.createDDoubleGrid2D(
