...
*/
public class DContinuous2DXYThinTester {
	/** The to test. */
	DContinuous2DXYThin toTest;
			...
			for (int ic = 3; ic < c; ic++) {
				for (int ii = 1; ii < ir - 1; ii++) {
					for (int ij = 1; ij < ic - 1; ij++) {
						...
						toTest = (DContinuous2DXYThin) DContinuous2DFactory.createDContinuous2DThin(/* discretization */0.5,
								10, 10, /* simState */
