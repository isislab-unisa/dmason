...
import it.isislab.dmason.experimentals.sim.field.grid.numeric.thin.DIntGrid2DThin;
...
public /*strictfp*/ class DAntsForage extends DistributedState<Int2D>
{
	...
	public void start()
	{
		...
		try 
		{       	
			toFoodGrid = DDoubleGrid2DFactory.createDDoubleGrid2DThin(GRID_WIDTH, GRID_HEIGHT, this, super.AOI, TYPE.pos_i, TYPE.pos_j, super.rows,super.columns, MODE, 0, false, "toFoodGrid", topicPrefix,false);
			toHomeGrid = DDoubleGrid2DFactory.createDDoubleGrid2DThin(GRID_WIDTH, GRID_HEIGHT, this, super.AOI, TYPE.pos_i, TYPE.pos_j, super.rows,super.columns, MODE, 0, false, "toHomeGrid", topicPrefix,false);
			buggrid = DSparseGrid2DFactory.createDSparseGrid2DThin(GRID_WIDTH, GRID_HEIGHT,this,super.AOI,TYPE.pos_i,TYPE.pos_j,super.rows,super.columns,MODE, "buggrid", topicPrefix,false);
			sites = DIntGrid2DFactory.createDIntGrid2DThin(GRID_WIDTH, GRID_HEIGHT, this, super.AOI, TYPE.pos_i, TYPE.pos_j, super.rows,super.columns, MODE, 0, true, "sites", topicPrefix,false);
			obstacles = DIntGrid2DFactory.createDIntGrid2DThin(GRID_WIDTH, GRID_HEIGHT, this, super.AOI, TYPE.pos_i, TYPE.pos_j, super.rows,super.columns, MODE, 0, true, "obstacles", topicPrefix,false);
			init_connection();
