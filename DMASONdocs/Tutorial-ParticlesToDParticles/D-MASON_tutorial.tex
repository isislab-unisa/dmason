...
\lstset{language=Java,caption={Class DFlockers},label={lst:batchAnnotation}}
\begin{lstlisting}
...
The \textit{Save button} will generate a configuration file that wil be used in the $JMasterUI$ application for starts the exploration.

\paragraph*{Manual setting}
The user can bypass the \textit{Batch Wizard} application and can set the parameters values by hand creating the XML configuration file.

An example of configuration file is showed in Listing: \ref{lst:confExample}

\lstset{language=Java,caption={Configuration file},label={lst:confExample}}
\begin{lstlisting}
<?xml version="1.0" encoding="UTF-8" ?>
<Batch>
  <simulationName>DFlockersSim.jar</simulationName>
  <neededWorkers>2</neededWorkers>
  <isBalanced>false</isBalanced>
  <simulationParams>
    <paramList name="width" type="double" runs="1" mode="list">
      <item>1</item>
      <item>2</item>
      <item>3</item>
    </paramList>
    <paramFixed name="height" type="double" runs="1" mode="fixed">
      <value>150.0</value>
    </paramFixed>
    <paramRange name="numFlockers" type="int" runs="1" mode="range">
      <start>100</start>
      <end>200</end>
      <increment>50</increment>
    </paramRange>
    <ParamDistributionUniform name="cohesion" type="double" runs="1" mode="distribution" distributionName="uniform" numberOfValues="2">
      <a>1</a>
      <b>5</b>
    </ParamDistributionUniform>
    <paramFixed name="avoidance" type="double" runs="1" mode="fixed">
      <value>1.0</value>
    </paramFixed>
    <paramFixed name="randomness" type="double" runs="1" mode="fixed">
      <value>1.0</value>
    </paramFixed>
    <paramFixed name="consistency" type="double" runs="1" mode="fixed">
      <value>1.0</value>
    </paramFixed>
    <paramFixed name="momentum" type="double" runs="1" mode="fixed">
      <value>1.0</value>
    </paramFixed>
    <paramFixed name="deadFlockerProbability" type="double" runs="1" mode="fixed">
      <value>0.1</value>
    </paramFixed>
    <paramFixed name="neighborhood" type="double" runs="1" mode="fixed">
      <value>10.0</value>
    </paramFixed>
  </simulationParams>
  <generalParams>
    <paramFixed name="Width" type="int" runs="1" mode="fixed">
      <value>100</value>
    </paramFixed>
    <paramFixed name="Height" type="int" runs="1" mode="fixed">
      <value>100</value>
    </paramFixed>
    <paramFixed name="MaxDistance" type="int" runs="1" mode="fixed">
      <value>100</value>
    </paramFixed>
    <paramFixed name="NumAgents" type="int" runs="1" mode="fixed">
      <value>15</value>
    </paramFixed>
    <paramFixed name="Rows" type="int" runs="1" mode="fixed">
      <value>1</value>
    </paramFixed>
    <paramFixed name="Columns" type="int" runs="1" mode="fixed">
      <value>2</value>
    </paramFixed>
    <paramFixed name="MaxStep" type="long" runs="1" mode="fixed">
      <value>1000</value>
    </paramFixed>
  </generalParams>
</Batch>
