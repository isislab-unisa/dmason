...
\lstset{language=Java,caption={Classe Particle},label=particle1}
\begin{lstlisting}
...
...
\lstset{language=Java,caption={Classe DParticle},label=dparticle1}
\begin{lstlisting}
...
\lstset{language=Java,caption={Classe Particle},label=particle2}
\begin{lstlisting}
   ...
...
\lstset{language=Java,caption={Classe DParticle},label=dparticle2}
\begin{lstlisting}
   ...
  public void step(SimState state) 
  {
